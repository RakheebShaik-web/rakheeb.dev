...
function App() {
  ...
  useEffect(() => {
    const typed = new Typed('.typed-headline', {
      strings: ['Algorithmic Trader', 'Quant Developer', 'Problem Solver'],
      typeSpeed: 70,
      backSpeed: 30,
      loop: true,
    });
  ...
  return <main>
    ...
    <section className="hero" id="top"><div className="hero-meta"><span>HYDERABAD / INDIA</span></div><div className="hero-copy"><p className="eyebrow">ALGORITHMIC TRADER · QUANT DEVELOPER</p><h1><span className="typed-headline"></span></h1><p className="intro">Quantitative trading systems built from research, tested through data, and deployed with disciplined execution.</p></div><figure className="hero-art"><img src="/hero-probability.png" alt="Probability paths converging around a realized market price series"/><figcaption>PROBABILITY / PATH / EXECUTION</figcaption></figure><p className="hero-note">A SYSTEM IS A HYPOTHESIS<br/>WITH CONSEQUENCES.</p></section>
