...
const studies = [
  { tag: "LIVE AUTOMATION", status: "LIVE / MONITORED", title: "Automated U.S. Stock Trading Bot", problem: "Manual monitoring makes systematic swing execution inconsistent across a broad U.S. equity universe.", approach: "Ranks liquid stocks, confirms trend and momentum on completed bars, then sizes every trade using account risk and ATR based invalidation.", architecture: "Python execution engine, Alpaca Trading API, market data validation, bracket orders, persistent trade state, Discord operations alerts, and EOD reconciliation.", flow: ["MARKET DATA", "SCREENER", "RISK ENGINE", "ALPACA", "MONITORING"], link: "https://github.com/RakheebShaik-web/alpaca.bot-eod-dashboard", result: "A fully automated pipeline from screening to order management, with exposure caps, duplicate order protection, and auditable live decisions." },
  { tag: "DERIVATIVES SYSTEM", status: "RESEARCH / DEVELOPMENT", title: "NSE Options Selling System", problem: "Selling premium without regime and volatility filters can expose capital to weak risk and reward conditions and sudden volatility expansion.", approach: "Selects liquid NSE F&O underlyings using India VIX, IV percentile, IV rank, trend, liquidity, and event risk filters before choosing defined risk structures.", architecture: "Python research stack, historical options chain processing, SPAN aware margin modeling, scenario stress tests, and a Kite Connect execution roadmap.", flow: ["CHAIN DATA", "VOLATILITY FILTER", "STRUCTURE", "RISK", "EXECUTION"], link: "https://github.com/RakheebShaik-web/stocks-options-strategy", result: "A repeatable options selling framework built around controlled sizing, portfolio Greeks, adjustment rules, and hard daily loss limits." },
  { tag: "RESEARCH PLATFORM", status: "ACTIVE RESEARCH", title: "Quant Screener", problem: "Finding quality investments and timely trading opportunities across thousands of securities is slow and vulnerable to narrative bias.", approach: "Combines quality, value, momentum, volatility, liquidity, and trend factors into ranked watchlists for medium term investing and tactical trades.", architecture: "Python factor pipeline, normalized factor scoring, market regime filters, PostgreSQL history, scheduled refreshes, and an interactive React results layer.", flow: ["DATA INGEST", "FACTOR MODEL", "REGIME FILTER", "RANKING", "WATCHLIST"], link: "https://github.com/RakheebShaik-web/quant-screener", result: "Surfaces strong candidates with clear factor attribution, allowing every shortlist to be explained and reproduced." },
];
